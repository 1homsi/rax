...
use raxon_core::{Color, Index, Rect, Size};
...
/// [`LayoutStyle`](raxon_core::LayoutStyle), retained on the node, and produce
...
pub struct TextSpan {
    ...
    pub text: String,
    /// Optional text color.
    pub color: Option<raxon_core::Color>,
...
impl TextSpan {
    ...
    /// Set the span color.
    pub fn color(mut self, c: raxon_core::Color) -> Self {
        self.color = Some(c);
        self
    }
