...
use raxon_core::{Color, ColorScheme, EdgeInsets, Point, Rect, Size};
use raxon_dom::{
...
// TextStyle is referenced as raxon_dom::TextStyle in the match arms.
use raxon_runtime::App;
use raxon_view::View;
            ...
            BATTERY_TICK.with(|c| {
                ...
                if tick % 60 == 0 {
                    unsafe {
                        ...
                        raxon_runtime::update_battery(level.max(0.0), charging);
                    }
                }
            });
    ...
    impl ActionTarget {
        ...
        fn pinch_recognized(&self, recognizer: &UIPinchGestureRecognizer) {
            ...
            dispatch_target_event(
                move |target| raxon_dom::Event::PinchChanged {
                    target,
                    scale,
                    velocity,
                    phase,
        ...
        fn rotate_recognized(&self, recognizer: &UIRotationGestureRecognizer) {
            ...
            dispatch_target_event(
                move |target| raxon_dom::Event::RotateChanged {
                    target,
                    rotation,
                    velocity,
                    phase,
...
fn setup(mtm: MainThreadMarker) {
    ...
    raxon_net::set_client(crate::http::UreqClient);
    // Persist rax-store keys to NSUserDefaults across launches.
    raxon_store::set_storage(crate::storage::UiKitStorage);
            ...
            Mutation::SetAttribute { id, attr } => {
                ...
                match attr {
                    ...
                    Attribute::TextAlign(align) => {
                        if let Ok(label) = view.clone().downcast::<UILabel>() {
                            let a = match align {
                                raxon_dom::TextAlign::Start => NSTextAlignment::Natural,
                                raxon_dom::TextAlign::Center => NSTextAlignment::Center,
                                raxon_dom::TextAlign::End => NSTextAlignment::Right,
                            };
                    ...
                    Attribute::AccessibilityRole(role) => {
                        ...
                        let traits: i64 = match role {
                            raxon_dom::Role::None => 0,
                            raxon_dom::Role::Button => 1 << 0,
                            raxon_dom::Role::Link => 1 << 1,
                            raxon_dom::Role::Image => 1 << 2,
                            raxon_dom::Role::Search => 1 << 10,
                            raxon_dom::Role::Adjustable => 1 << 12,
                            raxon_dom::Role::Header => 1 << 15,
                        };
                        unsafe {
                            let _: () = msg_send![&*view, setIsAccessibilityElement: true];
                    ...
                    Attribute::ImageResizeMode(mode) => {
                        ...
                        let content_mode: isize = match mode {
                            raxon_dom::ImageResizeMode::Stretch => 0,
                            raxon_dom::ImageResizeMode::Cover   => 1,
                            raxon_dom::ImageResizeMode::Contain => 2,
                            raxon_dom::ImageResizeMode::Center  => 4,
                            raxon_dom::ImageResizeMode::Repeat  => 0, // stub; tiling needs CALayer
                        };
                        unsafe {
                        ...
                        if let Ok(sv) = view.clone().downcast::<UIScrollView>() {
                            unsafe {
                                let v: isize = match mode {
                                    raxon_dom::KeyboardDismissMode::None => 0,
                                    raxon_dom::KeyboardDismissMode::OnDrag => 1,
                                    raxon_dom::KeyboardDismissMode::Interactive => 2,
                                };
                    ...
                    Attribute::ReturnKey(ret) => {
                        if let Ok(field) = view.clone().downcast::<UITextField>() {
                            let v: isize = match ret {
                                raxon_dom::ReturnKeyType::Default => 0,
                                raxon_dom::ReturnKeyType::Go => 1,
                                raxon_dom::ReturnKeyType::Next => 4,
                                raxon_dom::ReturnKeyType::Search => 8,
                                raxon_dom::ReturnKeyType::Send => 9,
                                raxon_dom::ReturnKeyType::Done => 9,
                            };
                            unsafe {
                    ...
                    Attribute::TextStyle(style) => {
                        let style_name = match style {
                            raxon_dom::TextStyle::LargeTitle => "UICTFontTextStyleLargeTitle",
                            raxon_dom::TextStyle::Title1 => "UICTFontTextStyleTitle1",
                            raxon_dom::TextStyle::Title2 => "UICTFontTextStyleTitle2",
                            raxon_dom::TextStyle::Title3 => "UICTFontTextStyleTitle3",
                            raxon_dom::TextStyle::Headline => "UIFontTextStyleHeadline",
                            raxon_dom::TextStyle::Subheadline => "UIFontTextStyleSubheadline",
                            raxon_dom::TextStyle::Body => "UIFontTextStyleBody",
                            raxon_dom::TextStyle::Callout => "UIFontTextStyleCallout",
                            raxon_dom::TextStyle::Footnote => "UIFontTextStyleFootnote",
                            raxon_dom::TextStyle::Caption1 => "UIFontTextStyleCaption1",
                            raxon_dom::TextStyle::Caption2 => "UIFontTextStyleCaption2",
                        };
                        if let Ok(label) = view.clone().downcast::<UILabel>() {
                            unsafe {
                    ...
                    Attribute::OnSwipe { direction, handler } => {
                        unsafe {
                            ...
                            let dir_bits: usize = match direction {
                                raxon_dom::SwipeDirection::Right => 1,
                                raxon_dom::SwipeDirection::Left => 2,
                                raxon_dom::SwipeDirection::Up => 4,
                                raxon_dom::SwipeDirection::Down => 8,
                            };
                    ...
                    Attribute::StatusBarStyle(style) => {
                        ...
                        unsafe {
                            ...
                            let style_val: i64 = match style {
                                raxon_dom::StatusBarStyle::Dark => 3,  // UIStatusBarStyleDarkContent
                                raxon_dom::StatusBarStyle::Light => 1, // UIStatusBarStyleLightContent
                                raxon_dom::StatusBarStyle::Auto => 0,  // UIStatusBarStyleDefault
                            };
