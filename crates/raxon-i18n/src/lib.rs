...
//!
//! ```no_run
//! use raxon_i18n::{provide_i18n, use_t, system_locale};
//!
...
/// [`create_root`](raxon_reactive::create_root) or effect).
///
/// ```no_run
/// use raxon_i18n::provide_i18n;
///
...
///
/// ```no_run
/// use raxon_i18n::{provide_i18n, system_locale};
///
