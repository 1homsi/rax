...
use raxon_core::{AlignItems, JustifyContent};
use raxon_reactive::{create_memo, create_signal, Memo, Signal};
...
/// # Example
/// ```rust
/// use raxon_view::layout::{use_layout_direction, LayoutDirection};
///
...
/// ```rust
/// use raxon_view::layout::{update_layout_direction, LayoutDirection};
///
...
/// # Example
/// ```rust
/// use raxon_view::{column, text, layout::expanded};
///
/// let v = column((
///     text("Header"),
...
/// # Example
/// ```rust
/// use raxon_view::{row, text, layout::flexible};
///
...
/// via [`LayoutStyle::aspect_ratio`](raxon_core::LayoutStyle::aspect_ratio).
...
/// # Example
/// ```rust
/// use raxon_view::{image, layout::aspect_ratio};
///
...
/// # Example
/// ```rust
/// use raxon_view::{text, layout::center};
///
...
/// # Example
/// ```rust
/// use raxon_view::{column, text, layout::{safe_area_top, safe_area_bottom}};
///
/// let v = column((
///     raxon_view::boxed(safe_area_top()),
///     raxon_view::boxed(text("Content")),
///     raxon_view::boxed(safe_area_bottom()),
/// ));
/// ```
...
/// # Example
/// ```rust
/// use raxon_view::{text, layout::safe_area_view};
///
...
/// # Example
/// ```rust
/// use raxon_view::{dynamic, text, boxed, layout::{use_orientation, Orientation}};
///
/// let v = dynamic(move || {
...
/// # Example
/// ```rust
/// use raxon_view::{dynamic, text, boxed, layout::use_window_width};
///
/// let v = dynamic(move || {
...
/// # Example
/// ```rust
/// use raxon_view::{dynamic, text, boxed, layout::{use_size_class, SizeClass}};
///
/// let v = dynamic(move || {
...
/// ```rust
/// use raxon_view::layout::update_window_size;
///
...
/// # Example
/// ```rust
/// use raxon_view::{text, boxed, layout::{responsive, SizeClass, Orientation}};
///
