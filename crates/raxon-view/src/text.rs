...
/// Build via [`rich_text`].
pub struct RichText {
    spans: Vec<raxon_dom::TextSpan>,
    number_of_lines: Option<u32>,
    align: Option<raxon_dom::TextAlign>,
}
...
impl RichText {
    /// Appends a [`TextSpan`](raxon_dom::TextSpan) to this rich text view.
    #[must_use]
    pub fn span(mut self, span: raxon_dom::TextSpan) -> Self {
    ...
    #[must_use]
    pub fn align(mut self, a: raxon_dom::TextAlign) -> Self {
        self.align = Some(a);
        self
    }
}
...
pub struct Text<M, T: IntoText<M>> {
    ...
    text_style: Option<raxon_dom::TextStyle>,
    letter_spacing: Option<f32>,
    line_height: Option<f32>,
    text_decoration: Option<raxon_dom::TextDecoration>,
    text_shadow: Option<(Color, f32, f32, f32)>,
    font_style: Option<raxon_dom::FontStyle>,
...
impl<M, T: IntoText<M>> Text<M, T> {
    ...
    #[must_use]
    pub fn align(mut self, align: raxon_dom::TextAlign) -> Self {
    ...
    #[must_use]
    pub fn text_style(mut self, style: raxon_dom::TextStyle) -> Self {
    ...
    pub fn underline(mut self) -> Self {
        self.text_decoration = Some(raxon_dom::TextDecoration::Underline);
        self
    }
    ...
    pub fn strikethrough(mut self) -> Self {
        self.text_decoration = Some(raxon_dom::TextDecoration::Strikethrough);
        self
    }
    ...
    #[must_use]
    pub fn font_style(mut self, style: raxon_dom::FontStyle) -> Self {
