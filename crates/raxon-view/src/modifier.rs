...
use raxon_core::{AlignItems, Color, Dimension, EdgeInsets, LayoutStyle, Point, Position};
use raxon_dom::{
    ...
    fn on_pan(
        ...
        self.decorate(move |t, id| {
            t.on(id, EventKind::Pan, move |event| {
                if let raxon_dom::Event::PanChanged {
                    translation,
                    velocity,
                    phase,
                    ..
    ...
    fn on_pinch(
        ...
        self.decorate(move |t, id| {
            t.on(id, EventKind::Pinch, move |event| {
                if let raxon_dom::Event::PinchChanged {
                    scale,
                    velocity,
                    phase,
                    ..
    ...
    fn on_rotate(
        ...
        self.decorate(move |t, id| {
            t.on(id, EventKind::RotateChanged, move |event| {
                if let raxon_dom::Event::RotateChanged {
                    rotation,
                    velocity,
                    phase,
                    ..
