...
use raxon_dom::{Attribute, Event, Host, Mutation, RecordingBackend, Tree, WidgetId, WidgetKind};
...
fn counter_builds_initial_tree() {
    ...
    assert_eq!(style.direction, raxon_core::FlexDirection::Column);
    assert_eq!(style.gap, 8.0);
    assert_eq!(style.padding, raxon_core::EdgeInsets::all(16.0));
