...
macro_rules! rax_debug {
    (target: $target:expr, $($arg:tt)*) => {
        $crate::log::log($crate::log::Level::Debug, $target, &format!($($arg)*))
    };
    ($($arg:tt)*) => {
        $crate::log::log($crate::log::Level::Debug, "rax", &format!($($arg)*))
    };
}
...
macro_rules! rax_info {
    ...
    ($($arg:tt)*) => {
        $crate::log::log($crate::log::Level::Info, "rax", &format!($($arg)*))
    };
}
...
macro_rules! rax_warn {
    ...
    ($($arg:tt)*) => {
        $crate::log::log($crate::log::Level::Warn, "rax", &format!($($arg)*))
    };
}
...
macro_rules! rax_error {
    ...
    ($($arg:tt)*) => {
        $crate::log::log($crate::log::Level::Error, "rax", &format!($($arg)*))
    };
}
