...
use raxon_core::{Color, ColorScheme, EdgeInsets, Rect, Size};
use raxon_dom::{Event, EventKind, EventSink, Host, Tree, WidgetId, WidgetKind};
use raxon_reactive::{create_memo, create_root, create_signal, provide_context, use_context, Memo, Scope, Signal};
use raxon_view::{mount, View};


// Re-export so callers can name the type without reaching into rax-dom.
pub use raxon_dom::{HapticStyle, KeyboardType, LocalNotification, TextStyle};

thread_local! {
    /// Haptic pulses queued by [`haptic`] during event handlers. Drained by
    /// [`App::tick`] after events are processed.
    static PENDING_HAPTICS: std::cell::RefCell<Vec<raxon_dom::HapticStyle>> =
...
/// to the user via [`last_panic`] and, typically, [`raxon_view::error_overlay`].
///
...
///
/// ```no_run
/// use raxon_runtime::install_error_overlay;
///
...
///
/// Pair with a reactive signal to drive [`raxon_view::error_overlay`]:
///
/// ```no_run
/// use raxon_runtime::last_panic;
...
///
/// ```no_run
/// use raxon_runtime::{haptic, HapticStyle};
///
...
///
/// ```no_run
/// use raxon_runtime::on_deep_link;
///
...
///
/// ```no_run
/// use raxon_runtime::{schedule_notification, LocalNotification};
///
...
///
/// ```no_run
/// use raxon_runtime::cancel_notification;
///
...
///
/// ```no_run
/// use raxon_runtime::authenticate_biometric;
///
...
///
/// ```no_run
/// use raxon_runtime::register_for_push;
///
/// register_for_push();
/// ```
...
///
/// ```no_run
/// use raxon_runtime::set_app_badge;
///
...
///
/// ```no_run
/// use raxon_runtime::set_clipboard;
///
...
///
/// ```no_run
/// use raxon_runtime::use_battery_level;
///
...
///
/// ```no_run
/// use raxon_runtime::use_battery_charging;
///
...
///
/// ```no_run
/// use raxon_runtime::{use_network_status, NetworkStatus};
///
...
///
/// ```no_run
/// use raxon_runtime::use_keyboard_height;
///
...
///
/// ```no_run
/// use raxon_runtime::{set_backdrop, Backdrop};
...
///
/// ```no_run
/// use raxon_runtime::start_motion;
///
...
///
/// ```no_run
/// use raxon_runtime::register_background_task;
///
...
///
/// ```no_run
/// use raxon_runtime::schedule_background_task;
///
...
///
/// ```no_run
/// use raxon_runtime::save_ui_state;
///
...
///
/// ```no_run
/// use raxon_runtime::restore_ui_state;
///
...
///
/// ```no_run
/// use raxon_runtime::clear_ui_state;
///
...
impl App {
    ...
    pub fn tick(&mut self) {
        raxon_async::run_until_stalled(); // advance async tasks (may resolve resources)
    ...
    fn relayout(&mut self) {
        ...
        let computed = raxon_layout::compute(&self.tree, self.root, avail);
...
///
/// ```no_run
/// use raxon_runtime::current_frame;
///
...
///
/// ```no_run
/// use raxon_runtime::use_frame_counter;
///
...
///
/// ```no_run
/// use raxon_runtime::{debounce, use_frame_counter};
/// use raxon_reactive::create_signal;
///
