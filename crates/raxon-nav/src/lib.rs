...
//!
//! ```
//! use raxon_nav::{create_navigator, routes};
//! use raxon_view::{boxed, text, View};
//!
//! #[derive(Clone)]
...
use raxon_reactive::{create_signal, provide_context, use_context, Signal};
use raxon_view::{dynamic, BoxedView, View};
...
/// # Example
/// ```rust
/// use raxon_nav::{create_navigator, transition_routes, NavigationTransition};
/// use raxon_view::{boxed, text, View};
///
/// #[derive(Clone)]
    ...
    F: FnMut(R) -> BoxedView + 'static,
{
    ...
    use raxon_reactive::{create_effect, create_signal};
    use raxon_view::{boxed, column, dynamic, ViewExt};
