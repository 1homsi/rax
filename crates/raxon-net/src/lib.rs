...
//! [`Resource`](raxon_async::Resource)s.
//!
...
//!
//! ```
//! use raxon_net::{get, set_client, MockClient, Response};
//! use raxon_async::run_until_stalled;
...
use raxon_async::{create_resource, Resource};
...
///
/// ```no_run
/// use raxon_net::{connect_ws, WsMessage};
///
...
pub fn use_paginated<T: Clone + 'static>(initial_items: Vec<T>) -> Paginated<T> {
    Paginated {
        items: raxon_reactive::create_signal(initial_items),
        page: raxon_reactive::create_signal(0u32),
        loading: raxon_reactive::create_signal(false),
        has_more: raxon_reactive::create_signal(true),
    }
}
...
/// # Example
/// ```
/// use raxon_net::{use_query, set_client, MockClient, Response};
/// use raxon_async::run_until_stalled;
/// use raxon_reactive::create_root;
///
...
/// # Example
/// ```
/// use raxon_net::{use_query_stale, set_client, MockClient, Response};
/// use raxon_async::run_until_stalled;
/// use raxon_reactive::create_root;
///
/// set_client(MockClient::new(|_| Ok(Response::ok("[]"))));
...
///
/// ```no_run
/// use raxon_net::{connect_sse, SseEvent};
///
...
/// ```rust,ignore
/// use raxon_reactive::create_root;
/// use raxon_net::{get_json, set_client, MockClient, Response};
///
...
/// # Example
/// ```rust,ignore
/// use raxon_net::{download_with_progress, DownloadProgress};
///
